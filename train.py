...
from src.model import BindingModel, GraphBindingModel,GraphBindingModelv2
...
def main(
    ...
    model = GraphBindingModelv2(**model_config)
    model.to(device)
...
# Try to create TrainingArguments with only the basic parameters first
    ...
    torch.save(model.state_dict(), os.path.join(save_dir, "pytorch_modelv10.bin"))
    print("### Model Saved ###")
